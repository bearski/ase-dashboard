...
function makeGraphs(error, data) {
  ...
  // charts
  slaCategoryRowChart = dc.rowChart("#slaCategoryRowChart");
  slaQuestionRowChart = dc.rowChart("#slaQuestionRowChart");
  slaCategoryDataTable = dc.dataTable("#slaCategoryDataTable");
  slaQuestionDataTable = dc.dataTable("#slaQuestionDataTable");
  ...
  slaCategoryRowChart
    ...
    // slaCategoryRowChart.renderlet(function(chart) {
    //           dc.events.trigger(function() {
    //               console.log(slaCategoryRowChart.filters())
    //           });
    //       })
